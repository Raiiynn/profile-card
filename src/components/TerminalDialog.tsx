...
const TerminalDialog = ({ open, onOpenChange }: TerminalDialogProps) => {
  ...
  const [history, setHistory] = useState<TerminalLine[]>([
    { type: 'output', content: 'Welcome to raiiynnn\'s terminal. Type "help" for commands.' },
  ]);
  ...
  5. clear   - Clear terminal`;
        break;
      case 'server':
        response = '🎮 Discord Server: https://discord.gg/Azxnnv5Nfx';
        break;
      case 'about':
        response = `👤 About Me:
  Name: Raihan
  Age: 21
  Profession: Web Development/ Full Stack Developer`;
        break;
      case 'webinfo':
